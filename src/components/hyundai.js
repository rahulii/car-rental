...
class hyundai extends Component {
    ...
    render(){
        return(
            ...
            <div style={div2Style}>
            <div style={div3Style}>
            <img src={i20} style={img1Style}/>
            <div style={div4Style}>
        <h2> Hyundai Grand i20</h2>
